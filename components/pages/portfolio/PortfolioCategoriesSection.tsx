...
const PortfolioCategoriesSection = () => {
  ...
  const categories = [
    { name: 'All', icon: Globe, count: 150, color: 'from-orange-500 to-orange-600' },
    { name: 'Web Development', icon: Globe, count: 45, color: 'from-orange-500 to-orange-600' },
    { name: 'Mobile Apps', icon: Smartphone, count: 32, color: 'from-orange-500 to-orange-600' },
    { name: 'E-commerce', icon: ShoppingCart, count: 28, color: 'from-orange-500 to-orange-600' },
    { name: 'SaaS Platforms', icon: Code, count: 22, color: 'from-orange-500 to-orange-600' },
    { name: 'UI/UX Design', icon: Palette, count: 18, color: 'from-orange-500 to-orange-600' },
    { name: 'Digital Marketing', icon: TrendingUp, count: 15, color: 'from-orange-500 to-orange-600' },
    { name: 'Enterprise', icon: Building, count: 12, color: 'from-orange-500 to-orange-600' }
  ];
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <h3 className={`text-sm font-bold mb-1 ${
                activeCategory === category.name ? 'text-orange-600' : 'text-gray-900'
              }`}>
                {category.name}
              </h3>

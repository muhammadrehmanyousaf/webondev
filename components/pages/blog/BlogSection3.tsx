          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/10 rounded-lg p-4">
                ...
                <p className="text-orange-100 text-sm">Control alignment along the main axis</p>
              </div>
              <div className="bg-white/10 rounded-lg p-4">
                <h4 className="font-semibold mb-2">Align Items</h4>
                <p className="text-orange-100 text-sm">Control alignment along the cross axis</p>
              </div>
              <div className="bg-white/10 rounded-lg p-4">
                <h4 className="font-semibold mb-2">Flex Properties</h4>
                <p className="text-orange-100 text-sm">Control how items grow and shrink</p>
              </div>
            </div>
          </div>

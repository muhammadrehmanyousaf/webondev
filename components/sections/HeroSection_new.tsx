...
const HeroSection = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50 pt-20 md:pt-16">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="floating-1 absolute top-20 left-10 w-20 h-20 bg-orange-100 rounded-full opacity-60"></div>
        <div className="floating-2 absolute top-40 right-20 w-16 h-16 bg-orange-200 rounded-full opacity-50"></div>
        <div className="floating-3 absolute bottom-40 left-1/4 w-24 h-24 bg-orange-50 rounded-full opacity-40"></div>
        <div className="absolute top-1/2 right-10 w-32 h-32 bg-gradient-to-r from-orange-400/20 to-orange-500/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 ref={titleRef} className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            Transform Your
            <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-600 bg-clip-text text-transparent"> Digital Vision </span>
            Into Reality
          </h1>

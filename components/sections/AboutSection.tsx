        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent"> Since 2019</span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-700 mb-2">5+</div>
                <div className="text-gray-600 text-sm">Years Experience</div>
              </div>
            </div>

            <Button asChild size="lg" className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
